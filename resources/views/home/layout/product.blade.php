                ...
                <div class="product__details__pic">
                    <div class="product__details__pic__item">
                        <img class="product__details__pic__item--large"
                            src="{{ asset("./imgProduct/$data->img")}}" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <a href="{{ route('home.addcart', ['id_user'=>Auth::user()->id,'id_product'=>$data->id]) }}" class="primary-btn">Thêm vào giỏ</a>
                    <ul>
                        <li><b>Còn lại:</b> <span>{{$data->quantity}} kg</span></li>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab"
                                aria-selected="true">Về Chúng Tôi</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="tabs-1" role="tabpanel">
                            <div class="product__details__tab__desc">
                                <p>Chúng tôi là đại lí bán sỉ và lẻ các loại thực phẩm tươi sống sạch như rau, củ, quả, thịt, hải sản, các gói hàng được trang trí theo yêu cầu của bạn thông qua số điện thoại (0931 452 452 hoặc 0941 681 681) để được tư vấng một cách chính xác và nhanh nhất.  </p>
